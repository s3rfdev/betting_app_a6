...
class ConfigTab5 extends StatefulWidget {
  ConfigTab5({super.key, required this.next});
  Function next;

  @override
  State<ConfigTab5> createState() => _ConfigTab5State();
}

class _ConfigTab5State extends State<ConfigTab5> {
  bool isMale = true;
  List<String> years = [
    'Gain Weight',
    'Lose weight',
